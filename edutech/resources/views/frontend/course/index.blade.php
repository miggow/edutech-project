                            ...
                            @foreach ($courses as $course)
                                <div class="col-12 col-lg-6 mt-20">
                                        ...
                                        <figure>
                                            <div class="image-box">
                                                ...
                                                <a href="{{ route('detail.course', $course->id) }}">
                                                    <img src="{{ asset($course->image) }}" class="img-cover"
                                                        alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="avatar bg-gray200">
                                      <img src="./Khoá Học _ Di4L LMS_files/617a4f5d834c8.png" class="img-cover"
                                        alt="Huỳnh Thị Liên">
                                    </div>
                                    <a href="https://edulms.di4l.vn/lms/users/929/profile" target="_blank"
                                      class="user-name ml-5 font-14">Huỳnh Thị Liên</a>
                                  </div> --}}
                                                ...
                                                {{-- <div class="stars-card d-flex align-items-center  mt-15">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        ...
                                                        class="feather feather-star active">
                                                        <polygon
                                                    ...
                                                    <span class="badge badge-primary ml-10">4.00</span>
                                                </div> --}}
                                                <div class="d-flex justify-content-between mt-20">
                                                    {{-- <div class="d-flex align-items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                            ...
                                                            class="feather feather-clock webinar-icon">
                                                            <circle cx="12" cy="12" r="10">
                                                            </circle>
                                                            <polyline points="12 6 12 12 16 14"></polyline>
                                                        </svg>
                                                        <span class="duration font-14 ml-5">{{$course->module->duration}}</span>
                                                    </div> --}}
