                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td width="18%" class="text-left">
                                            <a class="text-primary mt-0 mb-1 font-weight-bold" href="#">
                                                {{ $course->title }}
                                            </a>
                                            <div class="text-small">{{empty($course->category) ? '' :$course->category->name }}</div>
                                        </td>
                                        <td class="text-left">Huỳnh Thị Liên</td>
                                        <td>{{ $course->current_price == 0 ? 'Miễn phí' : $course->current_price }}</td>
                                        <td>{{ $course->previous_price ?? 'Không có' }}</td>
                                        <td class="font-12">
                                            <a href="#" target="_blank" class="">3</a>
                                        </td>
                                        <td class="font-12">{{ \Carbon\Carbon::parse($course->created_at)->format('d/m/Y') }}</td>

                                        <td class="font-12">{{\Carbon\Carbon::parse($course->updated_at)->format('d/m/Y')  }}</td>
                                        <td>
                                        ...
                                        <td width="200" class="">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                    ...
                                                    <a href="{{route('admin.module.index', $course->id)}}"
                                                        class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 "
                                                        title="Module">
                                                        <i class="fa fa-edit"></i>
                                                    ...
                                                    <button
                                                        ...
                                                        data-confirm-href="{{route('admin.course.delete', $course->id)}}"
